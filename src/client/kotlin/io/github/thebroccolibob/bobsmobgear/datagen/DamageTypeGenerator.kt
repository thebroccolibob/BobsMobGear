...
class DamageTypeGenerator(
    ...
    companion object : RegistryBuilder.BootstrapFunction<DamageType> {
        ...
        override fun run(registerable: Registerable<DamageType>) {
            registerable.register(BobsMobGearDamageTypes.PROJECTILE_TELEFRAG, 0.1f, "telefrag", effects = DamageEffects.FREEZING)
            registerable.register(BobsMobGearDamageTypes.BASE_TELEFRAG, 0.1f, "telefrag", effects = DamageEffects.FREEZING)
            registerable.register(BobsMobGearDamageTypes.SELF_TELEFRAG, 0.1f, effects = DamageEffects.FREEZING)
        }
    }
}